...
export const getInpatientInfo = createAsyncThunk(
    ...
    async(selectedInInfo) => {
        const resp = await axios.post("http://192.168.0.34:9090/patient/outInfo",
        selectedInInfo,
        {
          headers: {
...
export const changeDischargeDueDate = createAsyncThunk(
  ...
  async(dischargeDueDateElement) => {
      const resp = await axios.put("http://192.168.0.34:9090/patient/dischargeDueDate",
...
export const getCareInfo = createAsyncThunk(
  ...
  async(elements) => {
      const resp = await axios.post("http://192.168.0.34:9090/admission/careInfos",
      elements,
      {
        headers: {
          "Content-Type" : `application/json`,
...
export const setCareInfo = createAsyncThunk(
  ...
  async(elements) => {
      const resp = await axios.post("http://192.168.0.34:9090/admission/createdCareInfo",
      elements,
      {
        headers: {
          "Content-Type" : `application/json`,
...
export const changeCareInfo = createAsyncThunk(
  ...
  async(elements) => {
      const resp = await axios.put("http://192.168.0.34:9090/admission/changedCareInfo",
      elements,
      {
        headers: {
          "Content-Type" : `application/json`,
...
export const getMediRecords = createAsyncThunk(
  ...
  async(elements) => {
      const resp = await axios.post("http://192.168.0.34:9090/admission/mediRecords",
      elements,
      {
        headers: {
          "Content-Type" : `application/json`,
...
export const setMediRecord = createAsyncThunk(
  ...
  async(elements) => {
      const resp = await axios.post("http://192.168.0.34:9090/admission/createdMediRecord",
      elements,
      {
        headers: {
          "Content-Type" : `application/json`,
...
export const changeMediRecord = createAsyncThunk(
  ...
  async(elements) => {
      const resp = await axios.put("http://192.168.0.34:9090/admission/changedMediRecord",
      elements,
      {
        headers: {
          "Content-Type" : `application/json`,
...
export const changeTakeMediStatus = createAsyncThunk(
  ...
  async(elements) => {
      const resp = await axios.put("http://192.168.0.34:9090/admission/changedMediRecord/status",
      elements,
      {
        headers: {
          "Content-Type" : `application/json`,
...
export const getInpatientSchedules = createAsyncThunk(
  ...
  async(specialityElements) => {
      const resp = await axios.post("http://192.168.0.34:9090/admission/schedules",
      specialityElements,
      {
        headers: {
          "Content-Type" : `application/json`,
...
export const setInpatientSchedule = createAsyncThunk(
  ...
  async(specialityElements) => {
      const resp = await axios.post("http://192.168.0.34:9090/admission/createdSchedule",
      specialityElements,
      {
        headers: {
          "Content-Type" : `application/json`,
...
export const changeSchedule = createAsyncThunk(
  ...
  async(specialityElements) => {
      const resp = await axios.put("http://192.168.0.34:9090/admission/changedSchedule",
      specialityElements,
      {
        headers: {
          "Content-Type" : `application/json`,
...
export const changeScheduleStatus = createAsyncThunk(
  ...
  async(data) => {
      const resp = await axios.put("http://192.168.0.34:9090/admission/changedSchedule/status",
      data,
      {
        headers: {
          "Content-Type" : `application/json`,
...
export const getReceiveHandOver = createAsyncThunk(
  ...
  async(specialityElements) => {
      const resp = await axios.post("http://192.168.0.34:9090/admission/toMyHandOvers",
      specialityElements,
      {
        headers: {
          "Content-Type" : `application/json`,
...
export const getSendHandOver = createAsyncThunk(
  ...
  async(specialityElements) => {
      const resp = await axios.post("http://192.168.0.34:9090/admission/fromMyHandOvers",
      specialityElements,
      {
        headers: {
          "Content-Type" : `application/json`,
...
export const setHandOver = createAsyncThunk(
  ...
  async(specialityElements) => {
      const resp = await axios.post("http://192.168.0.34:9090/admission/handOver",
      specialityElements,
      {
        headers: {
          "Content-Type" : `application/json`,
...
export const changeHandover = createAsyncThunk(
  ...
  async(elements) => {
      const resp = await axios.put("http://192.168.0.34:9090/admission/myHandOver",
      elements,
      {
        headers: {
          "Content-Type" : `application/json`,
