...
const DoctorScheduleModal = (props) => {
    ...
    useEffect(() => {
        ...
        axios.get("http://43.200.169.159:9090/user/myScheduleList", 
            {params : {date: date,
                       empIdPk: empIdPk
            }}
        ).then((res) => {
    ...
    const deleteSchedule = (schedulePk) => {
        ...
        axios.post("http://43.200.169.159:9090/user/deleteSchedule", JSON.stringify(data), 
            {headers: {
    ...
    const filtering = (checked, data) => {
        ...
        if(checked) {
            axios.get("http://43.200.169.159:9090/user/filterCategory", {
                params: {
                    category: data,
                    empIdPk: empIdPk,
                    date: date
