...
const InPatientDetailModal = ({ outInfoElements }) => {
    ...
    useEffect(() => {
        ...
        axios.post("http://localhost:9090/patient/outInfo", JSON.stringify(outInfoElement), 
        {
            headers: {
        ...
        axios.post("http://localhost:9090/admission/careInfos", JSON.stringify(outInfoElement), 
        {
            headers: {
                "Content-Type" : `application/json`,
              }
        ...
        axios.post("http://localhost:9090/admission/mediRecords", JSON.stringify(outInfoElement), 
        {
            headers: {
                "Content-Type" : `application/json`,
              }
