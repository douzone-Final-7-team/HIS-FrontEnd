...
const UpdateScheduleModal = ({schedulePk, closeModal}) => {
    ...
    useEffect(() => {
        ...
        axios.get("http://43.200.169.159:9090/user/selectedSchedule", {params :{scheduleIdPk: scheduleIdPk}})
        .then((res) => {
    ...
    const updateSchedule = () => {
        ...
        axios.post("http://43.200.169.159:9090/user/updateSchedule", JSON.stringify(data),
        {
          headers: {
