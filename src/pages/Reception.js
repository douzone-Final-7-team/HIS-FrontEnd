...
const Reception = () => {
  ...
  useEffect(()=>{
    axios.get("http://192.168.0.34:9090/outStatus/getwaiting4receipt")
         .then((res) => {
  ...
  function patientInfo() {
    if(window.event.keyCode === 13){
      axios.post("http://192.168.0.34:9090/patient/regInfo", {
  ...
  function receipt() {
    if(symptom.current!==null && symptom.current!==undefined && symptom.current!=='') {
      axios.post("http://192.168.0.34:9090/outStatus/receipt", {
        EMP_ID_PK: empIdTemp,
